...
import {dialog,createRadioButtons} from './util';

function textReplace(context) {
    var i18 = language.textReplace;
    ...
    function searchInLayer(layer) {
        ...
        }else if(layer.className() == 'MSDocument'){
        ...
        }else if(layer.className() == 'MSPage' || layer.className() == 'MSLayerGroup' || layer.className() == 'MSArtboardGroup' || layer.className() == 'MSSymbolMaster'){
