...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/UploadIcon.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  if (selection.length == 0 || selection.length > 1) {
    return sketch_ui__WEBPACK_IMPORTED_MODULE_3___default.a.message('请选择一个 Icon 上传');
  } else if (selection.length == 1) {
    sketch_ui__WEBPACK_IMPORTED_MODULE_3___default.a.message('加载中...');
  }

  layer = selection[0];
  var exportFormat = exportLayerAsBitmap(document, layer);
  var options = {
  ...
  webContents.on('showSvg', function (s) {
    webContents.executeJavaScript("showSvg(".concat(JSON.stringify(exportFormat), ")")).catch(console.error);
  });
...
function exportLayerAsBitmap(document, layer) {
  ...
  var ret = {
    IconContent: encodeURIComponent(String(_skpm_fs__WEBPACK_IMPORTED_MODULE_0__["readFileSync"](path, 'utf8'))),
