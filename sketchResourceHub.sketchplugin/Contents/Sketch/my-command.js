...
module.exports = "file://" + context.plugin.urlForResourceNamed("_webpack_resources/67a7b3ac1df5615bbb02264bc8120ff5.html").path();
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  layer = selection[0];
  var svgString = exportLayerAsBitmap(document, layer);
  console.log(svgString);
  console.log(_typeof(svgString));
  var exportFormat = {
    svg: svgString
  };
  var options = {
  ...
  webContents.on('nativeLog', function (s) {
    ...
    webContents.executeJavaScript("setRandomNumber(".concat(JSON.stringify(exportFormat), ")")).catch(console.error);
  });
...
function exportLayerAsBitmap(document, layer) {
  ...
  return String(_skpm_fs__WEBPACK_IMPORTED_MODULE_0__["readFileSync"](path, 'utf8'));
